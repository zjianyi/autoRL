...
- **Fixed time budget.** 12 minutes wall-clock, always. Experiments are directly comparable regardless of what the agent changes — but absolute `avg_return` numbers are platform-specific. Relative improvement from baseline is always meaningful.
